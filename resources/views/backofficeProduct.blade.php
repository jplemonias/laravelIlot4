    ...
    <div class="row mb-3">
        <div class="col-md-12 themed-grid-col">
            @foreach ($data as $key => $game)
                <div class="col">
                    <div class="card w-100 h-100" style="margin-bottom: 1rem!important; margin-top: 1rem!important;">
                        <div class="card-body">
                            <div class="pb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 themed-grid-col">Category : {{$game->category_id}}</div>
